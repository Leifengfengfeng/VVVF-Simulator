...
namespace VVVF_Generator_Porting
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("8 : Generate Mascon Video");
            Console.WriteLine("9 : Generate Taroimo like Mascon Video");
            Console.WriteLine("10 : Realtime VVVF Sound generation");
            Console.WriteLine();
            ...
            for(int i = 0; i < split.Length; i++)
            {
                ...
                if (split[i] == "8") gen_mascon_video = true;
                if (split[i] == "9") gen_mascon_taroimo_video = true;
                if (split[i] == "10") realtime = true;
            }
